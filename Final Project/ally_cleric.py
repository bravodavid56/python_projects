...
class Cleric(Unit):
    """the supporting character, derived from Unit

    This class represents the supporting character.
    ...
    def __init__(self, ss, w, x=0, y=0):
        """initializes the Cleric object

        This function initializes the Cleric object with some
        ...
        Arguments:
            ...
            x (Int): x position of the Cleric
            y (Int): y position of the Cleric
        """
        super().__init__()
    ...
    def update(self, *args):
        ...
        the Cleric moves based on the direction faced, and
    ...
    def stand_frames(self, ss):
        ...
        image = ss.get_image(0, 0, ssh, ssw)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.stand_f.append(image)
        image = ss.get_image(0, 17, ssh, ssw)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.stand_f.append(image)
        image = ss.get_image(0, 33, ssh, ssw)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.stand_f.append(image)
        self.stand_f.append(image)
        self.stand_f.append(image)
    ...
    def selected_frames(self, w):
        ...
        Returns:
            None.
        """
        image = w.get_image(7, 394, 19, 25)
        image = pygame.transform.scale(image,(25,36))
        self.selected_f.append(image)
        ss = ((int)(19*1.3),(int)(28*1.05))
        image = w.get_image(5, 420, 19, 28)
        image = pygame.transform.scale(image,ss)
        self.selected_f.append(image)
        ss = ((int)(19*1.3),(int)(30*1.05))
        image = w.get_image(5, 450, 19, 30)
        image = pygame.transform.scale(image,ss)
        self.selected_f.append(image)
    ...
    def left_frames(self, w):
        ...
        ssht = (int)(19*1.3)
        sswt = (int)(19*1.3)
        image = w.get_image(5,15,19,17)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.walking_l_f.append(image)
        image = w.get_image(5, 47, 19, 17)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.walking_l_f.append(image)
        image = w.get_image(6, 79, 18, 17)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.walking_l_f.append(image)
        image = w.get_image(5, 111, 19, 17)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.walking_l_f.append(image)
        image = w.get_image(5, 47, 19, 17)
        image = pygame.transform.scale(image,(ssht,sswt))
    ...
    def up_frames(self, w):
        ...
        image = w.get_image(9, 271, ssh, ssw)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.walking_u_f.append(image)
        image = w.get_image(9, 303, ssh, ssw)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.walking_u_f.append(image)
        image = w.get_image(9, 335, ssh, ssw)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.walking_u_f.append(image)
        image = w.get_image(9, 367, ssh, ssw)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.walking_u_f.append(image)
    ...
    def down_frames(self, w):
        ...
        image = w.get_image(8, 143, ssh, ssw)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.walking_d_f.append(image)
        image = w.get_image(8, 175, ssh, ssw)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.walking_d_f.append(image)
        image = w.get_image(8, 206, ssh, ssw)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.walking_d_f.append(image)
        image = w.get_image(8, 239, ssh, ssw)
        image = pygame.transform.scale(image,(ssht,sswt))
        self.walking_d_f.append(image)
    ...
    def move(self, face):
        ...
        a cleric object; also updates the "done" property to
        disable further movements.

        Arguments:
            face (str): the direction faced by the Cleric
        """
        if self.c_move >= 6:
            self.done = True
            self.face = "s"
